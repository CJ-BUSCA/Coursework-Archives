/*
* Using a Function to Create Objects or Factory Pattern
*/
...
int main() {
	...
	*p2 = f.Create(); //Just assign the object reutrned from Create
	p1 = f.CreatePtr(); // or return a pointer to a heap
